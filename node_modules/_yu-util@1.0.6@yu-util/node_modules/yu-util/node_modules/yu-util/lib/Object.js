...
Object.asyncEach = function(obj,callback,interval=0) {
    ...
    function fn(result, obj){
        ...
        if(type === 'Object') {
            Object.keys(obj).forEach(key=>{
                let keyType = Object.getType(obj[key]);
                if( keyType==='Object' ){
                    result[key] = {};
                    ...
                    obj[key].forEach((val,i)=>{
                        let indexType = Object.getType(val);
                        if(indexType==='Object'){
                            result[key][i] = {};
                            fn(result[key][i], val);
...
Object.getFnNames = function(obj){
    fn(obj);
    function fn(obj){ 
        if(!obj) return;
